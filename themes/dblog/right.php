<div class="aside">
            ...
            <div class="sidenav">
                ...
                <?php $columns = EHOVEL::helper('column')->get_columns($site_id);
...
<!--                    </li>-->
            ...
            <?php $collection = EHOVEL::helper('Product')->collection('best_seller_index',5);
            	if (!empty($collection)){?>
            	<h2 class="h2">Best Sellers</h2>
                <ul class="seller_list">
                <?php foreach ($collection['products'] as $collection_product){?>
                	<li>
                    	<div class="pic"><a href="<?php echo $collection_product['url'];?>" class="img60x60"><img alt="<?php echo $collection_product['name'];?>" src="<?php echo EHOVEL::upload_url($collection_product['image'], '60x60');?>" /></a></div>
                        <div class="info">
                        	<h5><a href="<?php echo $collection_product['url'];?>" title=""><?php echo EHOVEL::helper('tool')->my_substr($collection_product['name'],20);?></a></h5>
                            <p class="price">
