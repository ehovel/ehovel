    ...
    jQuery(function($) {
        jQuery("#whitelist").jqGrid({
            ...
            colNames:[
                      	...
                      	,'<?php echo __('Publish At'); ?>'
                      	,'<?php echo __('Publish Author'); ?>'
                      	,'<?php echo __('Publish Source'); ?>'
            ...
            colModel:[
	            ...
	            ,{name:'publish_date',index:'publish_date',align:"center",width:120,searchoptions:{dataInit:datePick,sopt: ['lt','le','gt','ge']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.publish_date;
                }}
	            ,{name:'publish_author',index:'publish_author',width:120,searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.publish_author;
                }}
	            ,{name:'publish_source',index:'publish_source',width:120,searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.publish_source;
                }}
