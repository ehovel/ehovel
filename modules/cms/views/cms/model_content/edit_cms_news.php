        ...
        <form class="uniform" id="myForm" action="<?php echo url::current(true);?>" method="post">
            <fieldset>
                ...
                <dl class="inline">
                    ...
                    <dt><label for="publish_at"><?php echo __('Publish At');?><span class="require">*</span></label></dt>
					<dd>
						<input type="text" id="publish_date" name="publish_date"
							value="<?php echo !empty($model_content->individual_data)?substr($model_content->individual_data->publish_date, 0, 10):date('Y-m-d', time());?>"
							size="10" class="required text"
							style="background-color:#f1f1f1" readonly="true"/>
					</dd>
                    
                    <dt><label for="publish_author"><?php echo __('Publish Author'); ?></label></dt>
                    <dd>
                        <input type="text" id="publish_author" name="publish_author" class="medium" size="255"
                        	value="<?php echo !empty($model_content->individual_data)?$model_content->individual_data->publish_author:""; ?>"/>
                    </dd>

                    <dt><label for="publish_source"><?php echo __('Publish Source'); ?></label></dt>
                    <dd>
                        <input type="text" id="publish_source" name="publish_source" class="medium" size="255"
                        	value="<?php echo !empty($model_content->individual_data)?$model_content->individual_data->publish_source:""; ?>"/>
                    </dd>
