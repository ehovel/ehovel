    ...
    jQuery(function($) {
        jQuery("#whitelist").jqGrid({
            ...
            colModel:[
                ...
                ,{name:'operate',width:60,align:"center",sortable:false,stype:false,search:false,formatter:function(cellvalue, options, rowObject, action){
                    var h = '';
                    h += '<a href="<?php echo EHOVEL::url('cms_model/model_content_edit')?>?id=' + rowObject.id + '"><img alt="<?php echo __('Edit'); ?>" title="<?php echo __('Edit'); ?>" src="/statics/images/icons/splashyIcons/view_list.png" /></a>'
                    	+'&nbsp;&nbsp;<a href="<?php echo EHOVEL::url('cms_model/model_content_delete')?>?id=' + rowObject.id+'" class="remove"><img alt="<?php echo __('Delete'); ?>" title="<?php echo __('Delete'); ?>" src="/statics/images/icons/cross.png" /></a>';
                    return h;
                }}
	            ,{name:'title',index:'title',width:120,sortable:true,searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']}}
	            ...
	            ,{name:'subject',index:'subject',width:120,autowidth:true,sortable:true,searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.subject;
                }}
	            ,{name:'email',index:'email',width:120,sortable:true,searchoptions:{sopt:['eq','ne','bw','bn','ew','en','cn','nc']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.email;
                }}
	            ,{name:'date_from',index:'date_from',align:"center",width:120,searchoptions:{dataInit:datePick,sopt: ['lt','le','gt','ge']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.date_from;
                }}
	            ,{name:'date_to',index:'date_to',align:"center",width:120,searchoptions:{dataInit:datePick,sopt: ['lt','le','gt','ge']},formatter:function(cellvalue, options, rowObject, action){
	            	return rowObject.individual_data.date_to;
                }}
	            ,{name:'date_add',index:'date_add',align:"center",width:120,searchoptions:{dataInit:datePick,sopt: ['lt','le','gt','ge']}}
	            ,{name:"position",index:"position",align:"center",width:60,sortable:true,stype:false,search:false}
	        ],
            rowNum:20,
