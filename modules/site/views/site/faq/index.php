                ...
                <div id="tabs-1">
                    <div class="tableheader clearfix">
                        <div class="actions">
                            <ul class="tabletoolbar">
                                <li>
                                    <?php echo HTML::add_anchor(EHOVEL::url('site_faq/add'));?>
                                </li>
                                <li>
                                	<a href="<?php echo EHOVEL::url('site_faq_category/index');?>" class="invite"><?php echo __('Faq Category List');?></a>
                            	</li>
                            </ul>
                        </div>
                    </div>
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="datatable">
                        ...
                        <?php if ($site_faqs) { ?>
                            ...
                            <tr class="odd gradeU">
                                <td>
                                    <?php echo HTML::edit_anchor(EHOVEL::url('site_faq/edit') . '?id=' . $site_faq->id);?>
                                    &nbsp;&nbsp;
                                    <?php echo HTML::delete_anchor(EHOVEL::url('site_faq/delete') . '?id=' . $site_faq->id);?>
                                </td>
