                ...
                <div id="tabs-1">
                    <div class="tableheader clearfix">
                        <div class="actions">
                            <ul class="tabletoolbar">
                                <li>
                                    <?php echo HTML::add_anchor(EHOVEL::url('site_faq_category/add'));?>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="datatable">
                        ...
                        <?php if ($site_faq_categories) { ?>
                            ...
                            <tr class="odd gradeU">
                                <td>
                                    <?php echo HTML::edit_anchor(EHOVEL::url('site_faq_category/edit') . '?id=' . $site_faq_category->id);?>
                                    &nbsp;&nbsp;
                                    <?php echo HTML::delete_anchor(EHOVEL::url('site_faq_category/delete') . '?id=' . $site_faq_category->id);?>
                                </td>
