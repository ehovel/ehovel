...
<section class="container_12 clearfix">
    <section id="main">
        ...
        <article>
            <h2><?php echo __('Faq Category List');?></h2>
                ...
                <div id="tabs-1">
                    <div class="tableheader clearfix">
                        <div class="actions">
                            <ul class="tabletoolbar">
                                <li>
                                    <?php echo HTML::add_anchor(EHOVEL::url('site_tecfaq_category/add'));?>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="datatable">
                        ...
                        <tr>
                            ...
                            <th><?php echo __('Faq category name');?></th>
                            <th width="200"><?php echo __('Date add');?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if ($site_faq_categories) { ?>
                            <?php foreach ($site_faq_categories as $site_faq_category) { ?>
                            <tr class="odd gradeU">
                                <td>
                                    <?php echo HTML::edit_anchor(EHOVEL::url('site_tecfaq_category/edit') . '?id=' . $site_faq_category->id);?>
                                    &nbsp;&nbsp;
                                    <?php echo HTML::delete_anchor(EHOVEL::url('site_tecfaq_category/delete') . '?id=' . $site_faq_category->id);?>
                                </td>
                                <td><?php echo $site_faq_category->name;?></td>
                                <td><?php echo $site_faq_category->date_add;?></td>
                            </tr>
                                <?php } ?>
                            <?php }?>
                        </tbody>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery('.delete').unbind().bind('click', function() {
            ...
            jQuery.kMsg.warning('<?php echo __('Sure to delete the faq category?'); ?>', function() {
                location.href = href;
            });
            return false;
        });
