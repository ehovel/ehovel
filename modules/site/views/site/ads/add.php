    ...
    <article>
        ...
        <form class="uniform" id="myForm" action="<?php echo url::current(true);?>" method="post" enctype="multipart/form-data">
            <dl class="inline">
                ...
                <dd><input type="text" name="ads_title" id="ads_title" class="medium required" maxlength="20" /></dd>
                ...
                <?php if($isHide == 'text'):?>
                	...
                	<dd><textarea id="text_content" name="text_content" class="big required" type="textarea" ></textarea></dd>
                <?php elseif($isHide == 'code'):?>
                	<dt><label for="code_content"><?php echo __('Code Content');?><span class="require">*</span></label></dt>
                	<dd><textarea id="code_content" name="code_content" class="big required" type="textarea" ></textarea></dd>
                <?php else:?>
                <div id="t1">
                    <dt><label for="link_address"><?php echo __('Link Address');?></label></dt>
                    <dd>
                    	<input type="text" name="link_address" id="link_address" class="medium" maxlength="255" value="<?php echo 'http://';?>" />
                	</dd>
                               
                    <dt><label for="alt_tip"><?php echo __('Alt Tip');?></label></dt>
                    <dd>
                    	<input type="text" name="alt_tip" id="alt_tip" class="medium" maxlength="20" />
                	</dd>
                	
                	<dt><label for="image"><?php echo __('Images');?></label></dt>
                    <dd>
                    	<div id="image"<?php if (empty($ads_detail->imageurl)) { ?> style="display:none"<?php } ?>>
                            <img src="<?php if(isset($ads_detail->imageurl)){echo EHOVEL::upload_url($ads_detail->imageurl, '180x180');} ?>"/>
                ...
                <div id="t2">
                    ...
                    <dd>
                    	<input type="text" name="flash_address" id="flash_address" class="medium" maxlength="255" />
                	</dd>
                </div>
                <?php endif;?>
            </dl>
            <div class="buttons">
                ...
                <?php echo html::cancel_anchor(EHOVEL::url('site_ads',array('spaceid'=>$spaceid ,'type'=>$space_info->type ))); ?>
            </div>
        </form>
    </article>
</section>
