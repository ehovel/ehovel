...
<section class="container_12 clearfix">
    ...
    <article>
        <h1><?php echo __('Edit Store Address');?></h1>
        ...
        <form class="uniform" id="myForm" action="<?php echo url::current(true);?>" method="post"
            ...
            <dl class="inline">
                ...
                <dd><input type="text" name="store_name" id="store_name" class="medium required" maxlength="20" value="<?php echo $store_addresses->name;?>"/></dd>

                <dt><label for="is_default"><?php echo __('is_Default');?></label></dt>
                <dd>
                    <select name="is_default" id="is_default">
                        <option value="Y" <?php if($store_addresses->is_default=='Y'){ ?>selected="selected"<?php }?>><?php echo __('Yes');?></option>
                        <option value="N" <?php if($store_addresses->is_default=='N'){ ?>selected="selected"<?php }?>><?php echo __('No');?></option>
                    </select>
                </dd>
                ...
                <dd>
                    <select name="is_active" id="is_active">
                        <option value="Y" <?php if($store_addresses->active=='Y'){ ?>selected="selected"<?php }?>><?php echo __('Yes');?></option>
                        <option value="N" <?php if($store_addresses->active=='N'){ ?>selected="selected"<?php }?>><?php echo __('No');?></option>
                    </select>
                </dd>
                
                <dt><label for="is_active"><?php echo __('Store Warning Num');?></label></dt>
                <dd>
                    <input type="text" name="store_warning" id="store_warning" class="small required digits" maxlength="20" value="<?php echo $store_addresses->store_warning;?>"/>
                </dd>
