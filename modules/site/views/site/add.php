...
<section class="container_12 clearfix">
    ...
    <article>
        <h1><?php echo __('Add New Site');?></h1>
        ...
        <form class="uniform" id="myForm" action="<?php echo url::current(true);?>" method="post">
            <dl>
                ...
                <dd><input type="text" name="name" id="name" class="required" maxlength="255" value=""/></dd>
                <dt><label for="domain"><?php echo __('Domain');?><span class="require"> *</span></label></dt>
                <dd><input type="text" name="domain" id="domain" class="required" maxlength="255" value=""/></dd>
                <dt><label for="language"><?php echo __('Language');?><span class="require"> *</span></label></dt>
                <dd><input type="text" name="language" id="language" class="required" maxlength="255" value=""/></dd>
            </dl>
            <dl>
                <dt><label for="default"><?php echo __('Default');?></label></dt>
                <dd>
                    <label><input type="radio" value="Y" name="is_default" checked="checked"/><?php echo __('Yes');?></label>
